...
import {
  BookOpen, Zap, Key, CreditCard, Shield, ChevronRight,
  Terminal, CheckCircle2, ArrowRight, Copy, Check,
} from "lucide-react";
...
function CodeBlock({ code, language = "bash" }: { code: string; language?: string }) {
  ...
  return (
    <div
      className="relative rounded-xl text-sm font-mono mt-3 mb-5 group"
      style={{
        background: "#060e1c",
  ...
  return (
    ...
    >
      ...
      <div className="flex max-w-7xl mx-auto">
        {/* ── Sidebar ────────────────────────────────────────────────── */}
        <aside
          className="hidden md:flex flex-col w-60 shrink-0 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto py-8 px-4"
        ...
        >
          ...
          <div
            className="mt-8 mx-3 rounded-xl p-4"
            style={{
          ...
          >
            ...
            <a
              href="mailto:support@licenseadmin.io"
              className="text-xs font-medium flex items-center gap-1 transition-colors hover:text-cyan-300"
              style={{ color: "#06b6d4" }}
            >
          ...
          <section id="api-reference" className="mb-20 scroll-mt-20">
            ...
            <div className="space-y-4">
              {[
                ...
                const colors: Record<string, string> = { GET: "#34d399", POST: "#0ea5e9", PATCH: "#f59e0b", DELETE: "#f87171" };
                return (
                  <div
                    key={path + method}
                  ...
                  >
                    <span
                      className="text-xs font-bold font-mono mt-0.5 w-14 shrink-0 text-right"
                      style={{ color: colors[method] ?? "#94a3b8" }}
                    >
                      {method}
                    </span>
