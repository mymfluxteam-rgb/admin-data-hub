...
function GitHubIcon() {
    return (<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export default function LoginPage() {
    ...
    return (<div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#050d1a", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div className="login-card w-full max-w-md rounded-2xl p-8" style={{
            background: "#0a1628",
        ...
        <form onSubmit={handleLogin} className="space-y-4 mb-6">
          <div>
            ...
            <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@example.com" className="input-field w-full rounded-xl px-4 py-2.5 text-sm" style={{
            background: "#0f1929",
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <a href="#" className="text-xs transition-colors duration-200 hover:text-cyan-400" style={{ color: "#06b6d4" }}>
                Forgot password?
              </a>
            </div>
            <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="input-field w-full rounded-xl px-4 py-2.5 text-sm" style={{
            background: "#0f1929",
            border: "1px solid rgba(255,255,255,0.1)",
            color: "#e2e8f0",
        }}/>
          ...
          <button type="submit" disabled={loading} className="sign-in-btn w-full py-2.5 rounded-xl text-sm font-semibold mt-2" style={{
            background: loading
                ? "rgba(6,182,212,0.3)"
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button type="button" onClick={() => handleOAuth("google")} disabled={!!oauthLoading} className="social-btn flex items-center justify-center gap-2.5 py-2.5 rounded-xl text-sm font-medium" style={{
            ...
            {oauthLoading === "google" ? (<div className="h-4 w-4 rounded-full border-2 border-t-transparent animate-spin" style={{ borderColor: "rgba(255,255,255,0.3)", borderTopColor: "transparent" }}/>) : (<GoogleIcon />)}
            <span>{oauthLoading === "google" ? "Redirecting…" : "Google"}</span>
          </button>

          <button type="button" onClick={() => handleOAuth("github")} disabled={!!oauthLoading} className="social-btn flex items-center justify-center gap-2.5 py-2.5 rounded-xl text-sm font-medium" style={{
            ...
            {oauthLoading === "github" ? (<div className="h-4 w-4 rounded-full border-2 animate-spin" style={{ borderColor: "rgba(255,255,255,0.3)", borderTopColor: "transparent" }}/>) : (<GitHubIcon />)}
        ...
        <p className="text-center text-xs" style={{ color: "#475569" }}>
          ...
          <a href="#" className="transition-colors duration-200 hover:text-cyan-400" style={{ color: "#06b6d4" }}>
            Create account
          </a>
        </p>
        ...
        <div className="mt-6 pt-5 border-t text-center" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
          <Link to="/landing" className="text-xs transition-colors duration-200 hover:text-slate-300" style={{ color: "#475569" }}>
        ...
        {import.meta.env.DEV && (<div className="mt-5 pt-4 border-t" style={{ borderColor: "rgba(239,68,68,0.2)" }}>
