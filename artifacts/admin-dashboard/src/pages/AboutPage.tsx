    ...
    >
      ...
      <section className="relative py-28 px-6 text-center overflow-hidden">
        <div
          ...
          style={{ background: "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(6,182,212,0.09) 0%, transparent 70%)" }}
        />
        <p className="fade-up text-sm font-semibold mb-4 tracking-widest" style={{ color: "#06b6d4" }}>
          ABOUT US
        </p>
        <h1
          className="fade-up-1 font-black mb-6 mx-auto leading-tight"
          style={{
        ...
        <p
          className="fade-up-2 text-lg mx-auto mb-10 leading-relaxed"
          style={{ color: "#64748b", maxWidth: 640 }}
        >
        ...
        <Link
          to="/login"
          className="fade-up-3 inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl font-semibold text-base transition-all duration-300 hover:scale-105"
          style={{
            background: "linear-gradient(135deg, #0ea5e9, #06b6d4)",
            color: "#fff",
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {TEAM_VALUES.map((v) => (
            <div
              key={v.title}
              className="value-card rounded-2xl p-6"
              style={{
                background: "#0a1628",
                border: "1px solid rgba(255,255,255,0.07)",
                boxShadow: "6px 6px 16px rgba(0,0,0,0.4), -3px -3px 10px rgba(255,255,255,0.03)",
      ...
      <section className="py-20 px-6">
        ...
        >
          <div
            className="absolute inset-0 pointer-events-none"
            style={{ background: "radial-gradient(circle at 50% 0%, rgba(6,182,212,0.1) 0%, transparent 65%)" }}
          />
          <Users className="h-10 w-10 mx-auto mb-5 relative z-10" style={{ color: "#06b6d4" }} />
          <blockquote
            className="font-semibold mb-4 relative z-10 leading-relaxed"
            style={{
      ...
      <section className="py-20 px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            to="/login"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl font-semibold text-base transition-all duration-300 hover:scale-105"
            style={{
              background: "linear-gradient(135deg, #0ea5e9, #06b6d4)",
              color: "#fff",
              boxShadow: "0 8px 32px rgba(6,182,212,0.35)",
          ...
          <Link
            to="/docs"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl font-semibold text-base transition-all duration-200 hover:scale-105"
            style={{
