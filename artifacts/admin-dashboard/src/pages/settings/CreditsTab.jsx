...
import { PlanLockedRow, PlanLockedField } from "@/components/PlanLockedRow";
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            min={0.01}
                            step={0.01}
                            value={settings.base_credit_price}
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            type="number"
                            min={0}
                            value={settings.free_credits_on_registration}
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            type="number"
                            min={1}
                            value={settings.min_credit_purchase}
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            type="number"
                            min={1}
                            value={settings.max_credit_purchase}
                ...
                <CardContent className="space-y-4">
                    {features.creditExpiry ? (
                        ...
                        <div className="max-w-xs">
                            <PlanLockedField
                                label={t("credits.expiry")}
                                description={t("credits.expiryDesc")}
                            >
                    ...
                    <div className="border-t border-border/30 pt-4">
                        {features.autoDeduction ? (
                            <div className="flex items-center justify-between py-2">
                                ...
                                <Switch
                                    checked={settings.auto_deduction_enabled}
                                    onCheckedChange={(v) => update("auto_deduction_enabled", v)}
                                />
                            </div>
                        ) : (
                            <PlanLockedRow
                                label={t("credits.autoDeduction")}
                                description={t("credits.autoDeductionDesc")}
                                value={false}
                            />
                        )}
                    </div>
