      ...
      <Card className="border-border/50">
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input id="max_devices_per_user" type="number" min={1} value={settings.max_devices_per_user} onChange={(e) => update("max_devices_per_user", parseInt(e.target.value) || 3)}/>
          </div>
          <div className="space-y-2">
            <Label htmlFor="default_session_timeout">{t("hwid.sessionTimeout")}</Label>
            <Input id="default_session_timeout" type="number" min={1} value={settings.default_session_timeout} onChange={(e) => update("default_session_timeout", parseInt(e.target.value) || 120)}/>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-border/50">
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between py-2 border-b border-border/30">
            ...
            <Switch checked={settings.enforce_fingerprinting} onCheckedChange={(v) => update("enforce_fingerprinting", v)}/>
          </div>
          <div className="flex items-center justify-between py-2 border-b border-border/30">
            <div>
            ...
            <Switch checked={settings.auto_ban_device_switch} onCheckedChange={(v) => update("auto_ban_device_switch", v)}/>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-border/50">
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input id="device_switch_cooldown_hours" type="number" min={0} value={settings.device_switch_cooldown_hours} onChange={(e) => update("device_switch_cooldown_hours", parseInt(e.target.value) || 24)}/>
          ...
          <div className="space-y-2">
            ...
            <Input id="max_device_switches_per_day" type="number" min={0} value={settings.max_device_switches_per_day} onChange={(e) => update("max_device_switches_per_day", parseInt(e.target.value) || 2)}/>
          </div>
        </CardContent>
      </Card>
