                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                        {checkboxItems.map(([key, labelKey]) => (
                            <div key={key} className="flex items-center gap-2">
                                ...
                                />
                                <Label htmlFor={key} className="font-normal text-sm cursor-pointer">
                                    {t(labelKey)}
                                </Label>
                            </div>
                        ))}
            ...
            <Card className="border-border/50">
                ...
                <CardContent className="space-y-3">
                    {features.require2fa ? (
                        ...
                        <div className="border-b border-border/30">
                            <PlanLockedRow
                                ...
                                description={t("security.require2faDesc")}
                                value={false}
                            />
                        </div>
                    )}
                    ...
                    {features.ipBinding ? (
                        ...
                        <div className="border-b border-border/30">
                            <PlanLockedRow
                                label={t("security.ipBinding")}
                                description={t("security.ipBindingDesc")}
                                value={false}
                            />
                        </div>
                    )}
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3 border-t border-border/30 pt-4">
                        <div className="flex items-center justify-between py-2 border-b border-border/30">
                            ...
                            <Switch
                                checked={settings.failed_login_alert}
                        ...
                        <div className="flex items-center justify-between py-2">
                            ...
                            <Switch
                                checked={settings.suspicious_activity_alert}
