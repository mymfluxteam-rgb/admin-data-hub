...
function FloatingShape({
  ...
  size: number; top: string; left: string; delay: number; color: string; shape: "circle" | "triangle" | "square" | "hex";
}) {
...
function SkeletonCard() {
  return (
    <div
      className="rounded-2xl p-5 space-y-3 w-full max-w-xs mx-auto"
      style={{
        background: "#0f1929",
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-24 pb-16 overflow-hidden">
        ...
        {/* Badge */}
        <div
          className="fade-up inline-flex items-center gap-2 text-xs font-semibold px-4 py-1.5 rounded-full mb-6"
          style={{
        ...
        {/* Headline */}
        <h1
          className="fade-up-d1 font-black tracking-tight leading-[1.05] mb-6"
          style={{
        ...
        <p
          className="fade-up-d2 text-lg mb-10 max-w-2xl leading-relaxed"
          style={{ color: "#94a3b8" }}
        >
        ...
        <div className="fade-up-d3 flex flex-col sm:flex-row gap-4 items-center justify-center">
          ...
          <a
            href="#features"
            className="flex items-center gap-2 px-8 py-3.5 rounded-2xl font-semibold text-base transition-all duration-200 hover:scale-105"
            style={{
        ...
        <div
          className="fade-up-d4 mt-16 w-full max-w-4xl mx-auto rounded-2xl overflow-hidden relative"
          style={{
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(to bottom, transparent 70%, #050d1a 100%)" }}
          />
          <div
            style={{
              background: "#0a1628",
      ...
      <section id="features" className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((f, i) => (
            <ParallaxCard key={f.title} depth={i % 3 === 1 ? -0.8 : i % 3 === 0 ? -0.4 : -1.2}>
              <div
                className="feature-card rounded-2xl p-6 h-full cursor-pointer"
                style={{
                  background: "#0a1628",
      ...
      <section className="py-24 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t, i) => (
            <ParallaxCard key={t.name} depth={i === 1 ? -1.2 : -0.5}>
              <div
      ...
      <section className="py-24 px-6">
        ...
        >
          <div
            ...
            style={{ background: "radial-gradient(circle at 50% 0%, rgba(6,182,212,0.12) 0%, transparent 65%)" }}
          />
          <h2
          ...
          <Link
            to="/"
            className="relative z-10 inline-flex items-center gap-2 px-10 py-4 rounded-2xl font-bold text-base transition-all duration-300 hover:scale-105 hover:shadow-2xl"
            style={{
              background: "linear-gradient(135deg, #0ea5e9, #06b6d4)",
              color: "#fff",
